...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { address: @college.address, email: @college.email, mobile: @college.mobile, teacher: @college.teacher } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { address: @college.address, email: @college.email, mobile: @college.mobile, teacher: @college.teacher } }
